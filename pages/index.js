        ...
        <div>
          ...
          <div className="w w-96">
            ...
            <input
              ...
              id="search"
              className={`block w-full rounded-md border-0 py-3 px-3 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 ${
                !isURLValid && "invalid"
              }`}
              onKeyUp={async (e) => {
                if (e.key === "Enter") {
                  ...
                  if (isURL(url)) {
                    setIsURLValid(true);
                    // Logic to generate shortened URL and display it
                  } else {
                    setIsURLValid(false);
                  }
                }
